...
def createModel(characterdict, currentSession, mylanguage, test_par):
    ...
    for i in range(0, len(resp["rows"]) - 1, 1):
        ...
        if (mylanguage == "English"):
            ...
            unigram_list_len= len(unigram_list)
            unigram_synonyms_list = []
            ...
            for i in range(totalUnigrams):
                ...
                if i < totalUnigrams - 1:
                    ...
                    if ID not in characterdict[character].lemmatizedMap[bigram_lemma]:
                        ...
                        characterdict[character].lemmatizedMap[bigram_lemma][ID] += 1
                    characterdict[character].wordMap[bigram][ID]= characterdict[character].wordMap[bigram][ID]/totalUnigrams-1
                    characterdict[character].stemmedMap[bigram_stem][ID]= characterdict[character].stemmedMap[bigram_stem][ID]/totalUnigrams-1
                    characterdict[character].lemmatizedMap[bigram_lemma][ID]= characterdict[character].lemmatizedMap[bigram_lemma][ID]/totalUnigrams-1
                ...
                if i < totalUnigrams - 2:
                    ...
                    characterdict[character].wordMap[trigram][ID]= characterdict[character].wordMap[trigram][ID]/totalUnigrams-2
                    characterdict[character].stemmedMap[trigram_stem][ID]= characterdict[character].stemmedMap[trigram_stem][ID]/totalUnigrams-2
                    characterdict[character].lemmatizedMap[trigram_lemma][ID]= characterdict[character].lemmatizedMap[trigram_lemma][ID]/totalUnigrams-2
            # removes stop words
            ...
            for token in (unigram_list):
                ...
                characterdict[character].wordMap[token][ID]= characterdict[character].wordMap[token][ID]/unigram_list_len
                characterdict[character].stemmedMap[stem][ID]= characterdict[character].stemmedMap[stem][ID]/unigram_list_len
                characterdict[character].lemmatizedMap[lemma][ID]= characterdict[character].stemmedMap[stem][ID]/unigram_list_len
